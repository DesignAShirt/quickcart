...
(function (root, factory) {
  ...
  function applyProperties(target, obj, err) {
    obj = obj || {};
    for (var k in obj) {
      if (!(k in target)) {
        throw err;
  ...
  function Cart(items, options) {
    ...
    applyProperties(this.options, options, new Error('Invalid Cart option passed'));
  ...
  Cart.prototype = Object.create(EventEmitter);
  ...
  function Item(properties) {
    ...
    this.shippable    = null;
    this.taxable      = null;
    applyProperties(this, properties, new Error('Invalid Cart property passed'));
  }

  Item.prototype = Object.create(EventEmitter);
