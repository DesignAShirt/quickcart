...
(function (root, factory) {
  ...
  function Item(data) {
    ...
    var cartId, id, price, signature, properties, quantity;
    cartId      = 'cartId' in data ? data.cartId : ++_uid;
    id          = 'id' in data ? data.id : cartId;
  ...
  Cart.prototype.find = function(cartId) {
    return this.findBy('cartId', cartId);
  };
